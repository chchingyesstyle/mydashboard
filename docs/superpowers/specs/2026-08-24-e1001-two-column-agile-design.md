...
- The same left column is reused by the combined Forecast screen: all 12
  hourly entries occupy a 6-by-2 grid above seven compact daily rows. The
  fixed x=480 divider and right column remain unchanged.
